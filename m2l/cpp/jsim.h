#ifndef IIT_M2L_JSIM_H_
#define IIT_M2L_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot M2L.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::M2L::JointState, 2, 2, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::M2L::JointState, 2, 2, JSIM> Base;
    public:
