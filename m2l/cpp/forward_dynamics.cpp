...
const iit::M2L::dyn::ForwardDynamics::ExtForces
    iit::M2L::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

iit::M2L::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::M2L::dyn::ForwardDynamics::fd(
    JointState& qdd,
    const JointState& qd,
