...
using namespace iit::M2L::dyn;

// Initialization of static-const data
const iit::M2L::dyn::InverseDynamics::ExtForces
iit::M2L::dyn::InverseDynamics::zeroExtForces(Force::Zero());

iit::M2L::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
    ...
    {
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot M2L, InverseDynamics::InverseDynamics()" << std::endl;
...
void iit::M2L::dyn::InverseDynamics::id(
    JointState& jForces,
...
void iit::M2L::dyn::InverseDynamics::G_terms(JointState& jForces)
{
    // Link 'link1'
...
void iit::M2L::dyn::InverseDynamics::firstPass(const JointState& qd, const JointState& qdd, const ExtForces& fext)
{
