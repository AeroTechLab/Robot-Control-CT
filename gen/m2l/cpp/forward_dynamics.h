#ifndef IIT_ROBOT_M2L_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_M2L_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot M2L.
 *
...
public:
     ...
     *     the robot M2L, which will be used by this instance
