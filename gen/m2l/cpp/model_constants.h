#ifndef IIT_ROBOT_M2L_MODEL_CONSTANTS_H_
#define IIT_ROBOT_M2L_MODEL_CONSTANTS_H_
...
const Scalar tx_joint1 = 1.0;
const Scalar m_base0 = 1.0;
const Scalar m_link1 = 1.0;
const Scalar comx_link1 = 0.5;
const Scalar ix_link1 = 1.0;
const Scalar iy_link1 = 1.0;
const Scalar iz_link1 = 1.0;
const Scalar m_link2 = 1.0;
const Scalar comx_link2 = 0.5;
const Scalar ix_link2 = 1.0;
const Scalar iy_link2 = 1.0;
const Scalar iz_link2 = 1.0;
