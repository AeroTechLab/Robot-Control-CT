...
iit::M2L::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const iit::M2L::dyn::JSIM& iit::M2L::dyn::JSIM::update(const JointState& state) {
    Force F;
...
void iit::M2L::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void iit::M2L::dyn::JSIM::computeLInverse() {
